...
class RLHFDataset(Dataset):
    ...
    def __init__(
        ...
        if self.processor is not None:
            try:
                preprocessor_cls = map_processor_to_preprocessor(self.processor)
            except (KeyError, ValueError):
                preprocessor_cls = None
            if preprocessor_cls is not None:
                self.preprocessor = preprocessor_cls(
                    self.processor, image_key=self.image_key, video_key=self.video_key
                )
            ...
            if processor is not None:
                if self.preprocessor is not None:
                    ...
                    def doc2len(doc) -> int:
                        ...
                        _, _, input_ids, _, _ = self.preprocessor(messages, doc_copy)
    ...
    def __getitem__(self, item):
        ...
        if self.processor is not None:
            if self.preprocessor is not None:
                ...
                if not self.return_multi_modal_inputs:
